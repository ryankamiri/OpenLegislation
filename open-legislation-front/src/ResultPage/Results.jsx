...
function Results() {
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="text-gray-700 mt-2">Sponsored by: <span className="font-bold ">{billInfo.sponsor.fullName}</span></div>
            ...
            <div className="mt-4 w-full">
                ...
                <ul className="list-disc pl-5">
                    {billInfo.cosponsors.map((cosponsor, index) => (
                        <li key={index} className="text-gray-700">{cosponsor.fullName}</li>
                    ))}
                </ul>
            </div>
            <div className="">
            ...
            <div className="mt-4">
                <span className="font-semibold">Status:</span> The bill is currently waiting for approval from the <span className="font-medium">{billInfo.latestStage}</span>, since {billInfo.updateDate}
            </div>
