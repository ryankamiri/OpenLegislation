      ...
      {loading ? (
        ...
        <div className="shadow-lg p-6">
          ...
          <div className="text-gray-700 mt-2">
            Sponsored by:{" "}
            <span
              className={`font-bold ${getStyle(completeBill.bill.sponsor.fullName)}`}
            >
              {completeBill.bill.sponsor.fullName}
            </span>
          </div>
          ...
          <div className="mt-4">
            ...
            <span className="font-medium">{completeBill.bill.latestStage}</span>
            , since {getDate(completeBill.bill)}.
          </div>
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-700">
              {completeBill.analysis.potentialImpact}
            </p>
          </div>
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-700">
              {completeBill.analysis.impactedGroups}
            </p>
          </div>
